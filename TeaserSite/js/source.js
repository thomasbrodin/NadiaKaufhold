(function(){
  ...
  function createLights() {
    ...
    for (l = 0; l < LIGHT.count; l++) {
      ...
      // light.ring.setAttributeNS(null, 'stroke', '#232323');
      ...
      // light.core.setAttributeNS(null, 'fill', '#232323');
      // light.core.setAttributeNS(null, 'r', '2');
    }
  }
  ...
  function render() {
    ...
    if (LIGHT.draw) {
      ...
      for (l = scene.lights.length - 1; l >= 0; l--) {
        ...
        //     renderer.context.strokeStyle = '#232323';
        //     renderer.context.stroke();
        //     renderer.context.beginPath();
        //     renderer.context.arc(lx, ly, 4, 0, Math.PIM2);
        //     renderer.context.fillStyle = "#232323";
